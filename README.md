...
>Компания-оператор АТС: 
 1. Заключает договора с клиентами, 
 2. Присваивает им абонентские номера, 
 3. Предоставляет порты для подключения абонентских терминалов 
 4. Выдаёт каждому абоненту терминал (телефон). 
